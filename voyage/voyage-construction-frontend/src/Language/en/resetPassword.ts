const resetPassword = {
  ...
  error_valid_password:
    "At least 1 uppercase character,At least 1 lowercase character, At least 1 digit, At least 1 special character,Minimum 8 characters and Maximum 16 characters.",
