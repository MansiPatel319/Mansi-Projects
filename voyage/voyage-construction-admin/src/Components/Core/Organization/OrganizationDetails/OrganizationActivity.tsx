...
import {getOrganizationActivityDetail } from "../../../../Network/Core/Organization/OrganizationInfo";
...
const onChangeLastDate =async (e:any) => {
  ...
  const getOrganizationActivity = async (id: any) => {
    try {
      setIsLoading(true);
      const res = await getOrganizationActivityDetail(id,region,firstDate,lastDate,search,page,perPage);
