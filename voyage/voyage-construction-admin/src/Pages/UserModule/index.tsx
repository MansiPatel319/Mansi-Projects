...
// component
import UserModule from "../../Components/Core/UserModule";
import Leftbar from "../../Components/Comman/Leftbar";
import Header from "../../Components/Comman/Header";
import FilterModalUser from "../../Components/Comman/Modal/UserListFilterModel";
    ...
    <div id="wrapper">
      ...
      {/* <!-- Sidebar section End --> */}
        ...
        <div id="content">
          ...
          <UserModule handleClickModal={handleClickUpdateModal}  />
          {showModal && (
            <>

              <FilterModalUser handleClose={handleCloseModal} />
