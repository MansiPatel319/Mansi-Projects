...
function CategoryThirdComponent({ keyWord, searchKey }) {
                                            ...
                                            <div className="our-content-bottom-left">
                                                ...
                                                <div className="our-content-right">
                                                    <h3><Link to={`/user-feed-search/${keyWord.keyword}`} className="link">
                                                        ...
                                                        <span className="icon-rounded-span check-icon-rounded"><span className="material-icons">done</span></span> </Link></h3>
...
export default CategoryThirdComponent;

CategoryThirdComponent.propTypes = {
