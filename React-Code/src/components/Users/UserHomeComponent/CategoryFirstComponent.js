...
function CategoryFirstComponent({ keyWord, searchKey }) {
            ...
            <div className="common-card-class-feed-div">
                <div className="row">
                    {classData && classData.length > 0 && classData.slice(0, 1).map((data, i) => {
                        ...
                        return (
                            <div className="col-lg-6 col-md-12 left-big-img-order" key={i}>
                                <div className="common-feed-card-slider-bx-big">
                                    <div className="our-video-img-thumb">
                                        ...
                                        <div className="like-box-abs">
                                            <button className={`like-button ${data.is_favourite ? 'active' : ''}`} onClick={() => handleFavButtonClick(data.id, data.is_favourite)}>
                                        ...
                                        <div className="our-content-bottom-row">
                                            <div className="our-content-bottom-left">
                                                ...
                                                <div className="our-content-right">
                                                    <h3><Link to={`/user-feed-search/${keyWord.keyword}`} className="link">
                                                        
                                                         <span className="text-span"><span className="text-span">{name[0]}</span></span> <span className="icon-rounded-span check-icon-rounded"><span className="material-icons">done</span></span> </Link></h3>
                                ...
                                <div className="common-feed-card-slider-bx-half-small" key={i}>
                                    ...
                                    <div className="our-content-div">
                                        <div className="our-content-row">
                                            ...
                                            <div className="our-content-right">
                                                <h3><Link to={`/user-feed-search/${keyWord.keyword}`} className="link">{name[0]} <span className="icon-rounded-span check-icon-rounded"><span className="material-icons">done</span> </span></Link></h3>
                                                <p>{data.classListData}</p>
                                            </div>
                                        </div>
...
export default CategoryFirstComponent;

CategoryFirstComponent.propTypes = {
