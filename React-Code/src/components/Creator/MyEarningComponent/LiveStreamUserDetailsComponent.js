...
function LiveStreamUserDetailsComponent({
  recordTableHeader,
  userData,
  handleSearchInp,
  handleDateRange,
                      ...
                      <table className="table table-dark-custom">
                        <thead>
                          <tr>
                            ...
                            <th className="text-left width-15 min-width-90">Amount</th>
                            ...
                            userData.map((data, i) => {
                              return (
                                <tr key={i}>
                                  ...
                                  <td>${data.stream.creator_amount}</td>
                                    ...
                                    <ul>
                                      <li>
                                        <Link
                                          ...
                                          onClick={linkData.current === 1 ? handleFirstClick : null}
                                        >
                                      ...
                                      <li>
                                        <Link
                                          ...
                                          onClick={linkData.previous !== 0 ? handlePrevious : null}
                                        >
...
export default LiveStreamUserDetailsComponent;

LiveStreamUserDetailsComponent.propTypes = {
